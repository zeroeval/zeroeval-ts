...
/* ---------------- Trace signals ---------------- */
export function addPendingTraceSignal(
  traceId: string,
  name: string,
  signal: Signal
): void {
...
export function popPendingTraceSignals(
  traceId: string
...
/* ---------------- Session signals -------------- */
export function addPendingSessionSignal(
  sessionId: string,
  name: string,
  signal: Signal
): void {
...
export function popPendingSessionSignals(
  sessionId: string
): Record<string, Signal> | undefined {
