...
init({
  apiKey: 'sk_ze_xXFq28wFin66em0H9bCBYqPvheCMTbg0Xrc5rFsbsxg',
  debug: true,
});
...
const WeatherReportSchema = z.object({
  ...
  conditions: z
    .string()
    .describe('Weather conditions (e.g., sunny, cloudy, rainy)'),
  summary: z.string().describe('A brief summary of the weather'),
  recommendation: z
    .string()
    .describe('What to wear or bring based on the weather'),
});
